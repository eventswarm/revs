...
begin
  ...
  require 'com/opencsv/opencsv/5.1/opencsv-5.1.jar'
  ...
  require 'net/sf/opencsv/opencsv/2.3/opencsv-2.3.jar'
  require 'commons-logging/commons-logging/1.2/commons-logging-1.2.jar'
  require 'org/apache/commons/commons-text/1.8/commons-text-1.8.jar'
...
if defined? Jars
  ...
  require_jar 'com.opencsv', 'opencsv', '5.1'
  ...
  require_jar 'net.sf.opencsv', 'opencsv', '2.3'
  require_jar 'commons-logging', 'commons-logging', '1.2'
  require_jar 'org.apache.commons', 'commons-text', '1.8'
